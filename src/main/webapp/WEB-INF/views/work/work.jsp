                ...
                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-center mb-3">
                               	...
                               	<h5 class="font-size-15"><span class="float-end">61%</span></h5>
                                                        <div class="progress animated-progess progress-md">
                                                            <div class="progress-bar" role="progressbar" style="width: 61%" aria-valuenow="61" aria-valuemin="0" aria-valuemax="100"></div>
                                                        </div>
                                <div>
                                   	<input name ="start_work"id="start_work">출근시간 : <fmt:formatDate value="${wVo.start_work}" pattern="HH:mm:ss"/><br></div>
                                    <input name="end_work" id="end_work">	퇴근시간 :  <fmt:formatDate value="${wVo.end_work}" pattern="HH:mm:ss"/></div>
                                    </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                           ...
                           <div>
                               <a id = "start_btn" type="button" class="btn btn-light waves-effect" >출근하기</a>
                               <a id = "end_btn" type="button" class="btn btn-light waves-effect" >퇴근하기</a>
                           	</div>
                               <br>
...
<script>
	...
	b.onclick = function(){
		...
		$('#end_work').val(new Date());
		$('#input').submit();
		
	}
	a.onclick = function(){
		$('#start_work').val(new Date());
		$('#input').submit();
	...
	$.ajax({
		url : '/work_start_input',
		 data: { start_work:$('#start_work').val() },
			success : function(response){		
				console.log();
		if( response )
			alert('출근 되었습니다');
