...
<tr><th>성별</th>
	<td>
		<label><input type='radio' name='gender' value='남' ${Info.gender eq '남' ? 'checked' : ''}>남</label>
		<label><input type='radio' name='gender' value='여' <c:if test='${Info.gender eq "여"}'>checked</c:if> >여</label>
	</td>
</tr>
<tr><th>전화번호</th>
...
<tr><th>사원 승인여부</th>
	<td><label><input type='radio' name='join_check' value='Y' ${Info.join_check eq 'Y' ? 'checked' : ''}>승인</label>
		<label><input type='radio' name='join_check' value='N' <c:if test='${Info.join_check eq "N"}'>checked</c:if> >미승인</label>
	</td>
</tr>
